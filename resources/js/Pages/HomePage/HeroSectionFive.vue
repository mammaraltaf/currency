...
const goLeft = () => {
    if(currentPosition.value > 1){
        // move left
        currentTranslateValue.value = currentTranslateValue.value + reviewWidth.value;
...
const goRight = () => {
    if(currentPosition.value < 4){
        // move right
        currentTranslateValue.value = - ((reviewWidth.value * currentPosition.value)) ;
        reviewsElement.value.style.transform = `translateX(${currentTranslateValue.value}px)`;
        currentPosition.value++;
    }
}
    ...
    <div class="hero-section-five-container inside-container">
        ...
        <div class="flex flex-col justify-between">
            ...
            <div class="arrow-desktop">
                <ArrowLeft @click="goLeft" :color="currentPosition > 1 ? '#04A949' : ''" />
                <ArrowRight @click="goRight" :color="currentPosition < 4 ? '#04A949' : ''"/>
            </div>
        </div>
