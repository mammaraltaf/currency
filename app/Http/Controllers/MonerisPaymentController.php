...
class MonerisPaymentController extends Controller
{
    ...
    public function monerisPayment(Request $request)
    {
        ...
        try {
            // Obtain Moneris API credentials from .env
            $api_key =   'yesguy';
            ...
            // Define the Moneris API endpoint
            ...
            // Make a POST request to Moneris API
